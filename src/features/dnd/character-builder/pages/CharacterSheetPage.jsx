...
export default function CharacterSheetPage({ session, readOnly = false, characterId, campaignId, fromSession = false }) {
  ...
  // In lib/characterHydration.js extrahiert (das VTT nutzt dieselbe Hydration).
  // Der Wrapper injiziert die seiten-lokalen Kataloge (Refs).
  const collectActiveClassFeatures = (charData, classDataMap) =>
    collectActiveClassFeaturesShared(charData, classDataMap, {
