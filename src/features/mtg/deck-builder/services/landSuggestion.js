...
const LAND_CATALOG = {
  ...
  BG: [
    ...
    { name: 'Underground Mortuary', style: 'surveil',  priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  BR: [
    ...
    { name: 'Raucous Theater',    style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  BU: [
    ...
    { name: 'Undercity Sewers',    style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  BW: [
    ...
    { name: 'Shadowy Backstreet',   style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  GR: [
    ...
    { name: 'Commercial District', style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  GU: [
    ...
    { name: 'Hedge Maze',         style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  GW: [
    ...
    { name: 'Lush Portico',       style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  RU: [
    ...
    { name: 'Thundering Falls',   style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  RW: [
    ...
    { name: 'Elegant Parlor',     style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
  ...
  UW: [
    ...
    { name: 'Meticulous Archive',    style: 'surveil',   priceTier: 3, priceEur: 7.00, tapped: true,  fixesCount: 2, etbValue: 0.30 },
